...
const ResumenProducto = ({producto}) => {
  ...
  return (
    <di className='shadow p-5 mb-3 flex gap-10 items-center'>
      ...
      <div className='md:w-4/6'>
        ...
        <p className="text-2xl font-semibold mt-2">Cantidad: {producto.cantidad}</p>
      ...
      <div className="botones">
        ...
        <button
          ...
          className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md 
            font-bold uppercase shadow-md w-full mt-5"
